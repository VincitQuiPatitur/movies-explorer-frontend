...
function Profile() {
    return (
        <form className="profile">
            ...
            <h1 className="profile__greeting">Привет, user!</h1>
            <fieldset className="profile__form">
                <label className="profile__form-label">
                    <span className="profile__form-text">Имя</span>
                    <input placeholder="Имя" required type="text" className="profile__form-input"/>
                    <span className="profile__form-error"></span>
                </label>
                <label className="profile__form-label">
                    <span className="profile__form-text">E-mail</span>
                    <input placeholder="E-mail" required type="email" className="profile__form-input"/>
